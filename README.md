...
- **Configurable Build Parameters:** Supports environment variable overrides for compilation effort (`MX_EFFORT`), multi-processing (`MX_THREADS`), and experimental 16-bit precision (`MX_AUTO_DP`).
